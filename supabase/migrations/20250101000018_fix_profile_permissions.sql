-- Migration: Fix profile creation permissions
-- Description: Fixes the read-only transaction issue by adding proper security settings
-- Author: AI Assistant
-- Date: 2025-01-17
...
-- Create the function with SECURITY DEFINER to run with elevated permissions
...
-- Update the handle_email_confirmation function as well
